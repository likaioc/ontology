...
func NewConsensusService(consensusType string, account *account.Account, txpool *actor.PID, ledger *actor.PID, p2p *actor.PID, nodeId p2pCom.P2PNodeID) (ConsensusService, error) {
	if consensusType == "" {
